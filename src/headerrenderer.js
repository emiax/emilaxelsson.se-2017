import Buffer from 'stains/src/buffer';
import Shader from 'stains/src/shader';
import ShaderProgram from 'stains/src/shaderprogram';
import ShaderPass from 'stains/src/shaderpass';
import {vec2} from 'gl-matrix';
import glslPre from 'stains/src/glslpreprocessor';
import Triangulator from 'stains/src/triangulator';

import {lerp, smoothstep} from 'interpolation';

let vertexShaderSource = require('stains/src/shaders/header.vs')
let fragmentShaderSource = require('stains/src/shaders/header.fs')
let noise2D = require('stains/ext/webgl-noise/src/noise2D.glsl');
